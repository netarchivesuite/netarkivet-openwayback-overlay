...
CaptureSearchResult res =  data.curResult;
...
<div id="wm-ipp" style="display:none; position:relative;padding:0 5px;min-height:70px;min-width:800px; z-index:2000000001;">
...
--%>
   <a href="<%= queryPrefix %>" title="Netarkivet OpenWayback Homepage" style="background-color:transparent;border:none;">Netarkivet OpenWayback</a>
   </td>
   <td style="padding:0!important;text-align:center;vertical-align:top;width:100%;">
       ...
       <td style="vertical-align:middle;padding:0!important;">
           ...
           <div style="margin:0!important;padding:0!important;color:#666;font-size:9px;padding-top:2px!important;white-space:nowrap;" title="<%= fmt.format("ToolBar.curDayTitle",data.curResult.getCaptureDate()) %>"><%= fmt.format("ToolBar.curDayTitle",data.curResult.getCaptureDate()) %></div>
       </td>
       ...
       <div id="wm-ipp-sparkline" style="position:relative; white-space:nowrap; width:<%= imgWidth %>px;height:<%= imgHeight %>px;background-color:#fff;cursor:pointer;border-right:1px solid #ccc;" title="<%= fmt.format("ToolBar.sparklineTitle") %>">
			<img id="sparklineImgId" style="position:absolute; z-index:2000000013; top:0px; left:0px;"
			...
			<img id="wbMouseTrackYearImg"
				style="display:none; position:absolute; z-index:2000000011;"
				width="<%= yearWidth %>"
				height="<%= imgHeight %>"
				border="0"
				src="<%= staticPrefix %>images/toolbar/transp-yellow-pixel.png"></img>
			<img id="wbMouseTrackMonthImg"
				style="display:none; position:absolute; z-index:2000000012; "
				width="<%= monthWidth %>"
				height="<%= imgHeight %>"
				border="0"
   ...
   <td style="text-align:right;padding:5px;width:65px;font-size:11px!important;">
       ...
       <a href="<%= staticPrefix %>help.jsp" style="display:block;padding-right:18px;background:url(<%= staticPrefix %>images/toolbar/wm_tb_help.png) no-repeat 100% 0;color:#33f;font-family:'Lucida Grande','Arial',sans-serif;background-color:transparent;border:none;" title="<%= fmt.format("ToolBar.helpTitle") %>"><%= fmt.format("ToolBar.helpText") %></a>
   </td>
   </tr></tbody></table>
